...
export default function Home() {
  return (
    ...
    <main className="flex justify-center items-center mt-5 px-4 sm:px-6 lg:px-8">
         <div className="w-full md:w-5/6 lg:w-3/4 p-4 sm:p-6 md:p-8 bg-gray-300 shadow-gray-500 shadow rounded-lg">
             ...
             <div type="button" className="bg-blue-300 w-full text-gray-700 sm:w-2/3 md:w-2/5 lg:w-1/5 p-2 sm:p-3 mx-auto flex justify-center rounded-md shadow shadow-gray-500 hover:bg-blue-400 duration-500 hover:text-gray-200 hover:cursor-pointer hover:shadow-lg hover:shadow-gray-600">See About Us</div>
         </div>
     </main>
  ...
  <div className="w-full md:w-5/6 lg:w-3/4 p-4 sm:p-6 md:p-8 bg-gray-300 shadow-gray-500 shadow rounded-lg">
    ...
    <details className="p-2.5 border border-blue-400 mb-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 justify-center p-4">
        ...
        <div className="w-full p-4 bg-teal-200 rounded shadow shadow-teal-500 hover:shadow-lg hover:shadow-teal-400">
        ...
        <div className="w-full p-4 bg-teal-200 rounded shadow shadow-teal-500 hover:shadow-lg hover:shadow-teal-400 sm:col-span-2 lg:col-span-1">
